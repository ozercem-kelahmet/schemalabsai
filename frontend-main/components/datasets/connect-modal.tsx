...
type DatabaseProvider = "postgresql" | "supabase" | "mongodb" | "databricks" | "snowflake" | "pinecone"
...
const databaseProviders: { id: DatabaseProvider; name: string; icon: React.ReactNode; description: string }[] = [
  ...
  { id: "pinecone", name: "Pinecone", description: "Vector database for AI", icon: <Database className="h-5 w-5 text-muted-foreground" /> },
]
        ...
        {selectedProvider ? (
          ...
          <Tabs defaultValue="upload" className="w-full">
            ...
            <TabsContent value="api" className="mt-4 space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="api-endpoint" className="text-foreground">API Endpoint URL</Label>
                <Input
                  id="api-endpoint"
                  value={endpoint}
                  onChange={(e) => setEndpoint(e.target.value)}

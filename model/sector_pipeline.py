...
DATASETS = [
    ...
    {"id": "nalisha/heart-disease-prediction-dataset", "sector": "healthcare"},
    {"id": "nimapourmoradi/heart-failure-clinical-records", "sector": "healthcare"},
    {"id": "itachi9604/disease-symptom-description-dataset", "sector": "healthcare"},
    {"id": "alphiree/cardiovascular-diseases-risk-prediction-dataset", "sector": "healthcare"},
    {"id": "jimschacko/10-years-diabetes-dataset", "sector": "healthcare"},
    {"id": "palakjain9/1000-drugs-and-side-effects", "sector": "healthcare"},
    {"id": "jacksoncrow/stock-market-dataset", "sector": "finance"},
    {"id": "uciml/german-credit", "sector": "finance"},
    {"id": "nelgiriyewithana/credit-card-fraud-detection-dataset-2023", "sector": "finance"},
    {"id": "whenamancodes/fraud-detection", "sector": "finance"},
    {"id": "laotse/credit-risk-dataset", "sector": "finance"},
    {"id": "ulrikthygepedersen/online-retail-dataset", "sector": "ecommerce"},
    {"id": "shreyanshverma27/online-sales-dataset-popular-marketplace-data", "sector": "ecommerce"},
    {"id": "lokeshparab/amazon-products-dataset", "sector": "ecommerce"},
    {"id": "sujalsuthar/food-delivery-order-history-data", "sector": "ecommerce"},
    {"id": "maso0dahmed/football-players-data", "sector": "sports"},
    {"id": "hubertsidorowicz/football-players-stats-2024-2025", "sector": "sports"},
    {"id": "sumitrodatta/nba-aba-baa-stats", "sector": "sports"},
    {"id": "warcoder/atp-tennis-rankings-results-and-stats1968-2023", "sector": "sports"},
    {"id": "philiphyde1/nfl-stats-1999-2022", "sector": "sports"},
    {"id": "pralabhpoudel/world-energy-consumption", "sector": "energy"},
    {"id": "anikannal/solar-power-generation-data", "sector": "energy"},
    {"id": "henriupton/wind-power-production-us-2001-2023", "sector": "energy"},
    {"id": "twinkle0705/state-wise-power-consumption-in-india", "sector": "energy"},
    {"id": "sobhanmoosavi/us-accidents", "sector": "transportation"},
    {"id": "usdot/flight-delays", "sector": "transportation"},
    {"id": "yasserh/uber-fares-dataset", "sector": "transportation"},
    {"id": "fedesoriano/traffic-prediction-dataset", "sector": "transportation"},
    {"id": "samuelotiattakorah/agriculture-crop-yield", "sector": "agriculture"},
    {"id": "snmahsa/soil-nutrients", "sector": "agriculture"},
    {"id": "irakozekelly/fertilizer-prediction", "sector": "agriculture"},
    {"id": "researcher1548/livestock-symptoms-and-diseases", "sector": "agriculture"},
    {"id": "slwessels/crime-statistics-for-south-africa", "sector": "government"},
    {"id": "yashdogra/lacrime", "sector": "government"},
    {"id": "tunguz/us-elections-dataset", "sector": "government"},
    {"id": "alessandrolobello/the-ultimate-earthquake-dataset-from-1990-2023", "sector": "government"},
    {"id": "fahmidachowdhury/manufacturing-defects", "sector": "manufacturing"},
    {"id": "arnabbiswas1/microsoft-azure-predictive-maintenance", "sector": "manufacturing"},
    {"id": "brjapon/gearbox-fault-diagnosis", "sector": "manufacturing"},
    {"id": "samira1992/student-grades-intermediate-dataset", "sector": "education"},
    {"id": "dastgeerjutt/student-academic-performance-and-learning-outcomes", "sector": "education"},
    {"id": "ankushnarwade/ai-impact-on-student-performance", "sector": "education"},
    {"id": "saadaliyaseen/analyzing-student-academic-trends", "sector": "education"},
    {"id": "carlospereavega/employee-attrition-performance", "sector": "hr"},
    {"id": "nadeemajeedch/employee-performance-and-salary-dataset", "sector": "hr"},
    {"id": "prince7489/employee-salary-dataset", "sector": "hr"},
    {"id": "hopesb/hr-analytics-dataset", "sector": "hr"},
    {"id": "brsahan/advertising-spend-vs-sales", "sector": "marketing"},
    {"id": "abisheksudarshan/customer-segmentation", "sector": "marketing"},
    {"id": "vetrirah/customer", "sector": "marketing"},
    {"id": "nudratabbas/global-ads-performance-google-meta-tiktok", "sector": "marketing"},
    {"id": "sevgisarac/temperature-change", "sector": "climate"},
    {"id": "azminetoushikwasi/aqi-air-quality-index-scheduled-daily-update", "sector": "climate"},
    {"id": "dheemanthbhat/simple-weather-forecast", "sector": "climate"},
    {"id": "jawadawan/global-warming-trends-1961-2022", "sector": "climate"},
    {"id": "crawford/computer-network-traffic", "sector": "cybersecurity"},
    {"id": "teamincribo/cyber-security-attacks", "sector": "cybersecurity"},
    {"id": "subhajournal/android-malware-detection", "sector": "cybersecurity"},
    {"id": "ziya07/network-traffic-anomaly-detection-dataset", "sector": "cybersecurity"},
    {"id": "mastmustu/insurance-claims-fraud-data", "sector": "insurance"},
    {"id": "buntyshah/auto-insurance-claims-data", "sector": "insurance"},
    {"id": "anmolkumar/health-insurance-cross-sell-prediction", "sector": "insurance"},
    {"id": "floser/french-motor-claims-datasets-fremtpl2freq", "sector": "insurance"},
    {"id": "camnugent/california-housing-prices", "sector": "realestate"},
    {"id": "yasserh/housing-prices-dataset", "sector": "realestate"},
    {"id": "mirbektoktogaraev/madrid-real-estate-market", "sector": "realestate"},
    {"id": "computingvictor/zillow-market-analysis-and-real-estate-sales-data", "sector": "realestate"},
    {"id": "gregorut/videogamesales", "sector": "entertainment"},
    {"id": "arnavsmayan/spotify-dataset", "sector": "entertainment"},
    {"id": "harshsingh7/logistics-and-supply-chain-management", "sector": "supplychain"},
